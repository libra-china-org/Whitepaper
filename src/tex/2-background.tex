...
\zhou{
    We just clarify several problems here: What's Event Sourcing and CQRS? (Generally introduce) What problems we want to solve with the introduction of these technologies?
}
